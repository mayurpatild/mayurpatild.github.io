...
const ProjectGPS = lazy(() => import('pages/Gps'));
const ProjectOBD = lazy(() => import('pages/Obd'));
...
const AppRoutes = () => {
  ...
  return (
    <Fragment>
      <Helmet>
        <link rel="canonical" href={`https://mayurpatild.com${pathname}`} />
      </Helmet>
              ...
              <div className={classNames('app__page', `app__page--${status}`)}>
                <Suspense fallback={<Fragment />}>
                  <Switch location={location}>
                    ...
                    <Route path="/projects/obd" component={ProjectOBD} />
                    <Route path="/projects/gps" component={ProjectGPS} />
